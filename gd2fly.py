...
def print_forecast(args):
    ...
    print( HC + "\t\tForecast: ")
    print( HC + "\tDate: " + LC + fct[0][0] + HC + " Temp: " + LC + str(fct[0][1]) + HC + " Wind: " + LC + str(fct[0][2]) + HC + " Desc: " + LC + fct[0][3] )
    print( HC + "\tDate: " + LC + fct[1][0] + HC + " Temp: " + LC + str(fct[1][1]) + HC + " Wind: " + LC + str(fct[1][2]) + HC + " Desc: " + LC + fct[1][3] )
    print( HC + "\tDate: " + LC + fct[2][0] + HC + " Temp: " + LC + str(fct[2][1]) + HC + " Wind: " + LC + str(fct[2][2]) + HC + " Desc: " + LC + fct[2][3] )
    print( HC + "\tDate: " + LC + fct[3][0] + HC + " Temp: " + LC + str(fct[3][1]) + HC + " Wind: " + LC + str(fct[3][2]) + HC + " Desc: " + LC + fct[3][3] )
